...
(0, vitest_1.describe)('calculateDiscount', () => {
    (0, vitest_1.test)('should return discounted price if given valid code', () => {
    ...
    (0, vitest_1.test)('should handle negative price', () => {
        (0, vitest_1.expect)((0, main_1.calculateDiscount)(-10, 'SAVE10')).toMatch(/invalid/i);
    });
    (0, vitest_1.test)('should handle invalid discount price', () => {
